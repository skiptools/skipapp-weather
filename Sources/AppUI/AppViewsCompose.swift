    ...
    func CounterStateView() {
        ...
        func CounterView(label: String, visible: Bool) {
            ...
            Button(onClick: {
                ...
                Text("\(label) \(androidx.compose.runtime.currentCompositeKeyHash): \(countState.value)", color: visible ? androidx.compose.ui.graphics.Color.White : androidx.compose.ui.graphics.Color.Yellow)
            }
        }
